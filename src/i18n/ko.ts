export const ko = {
  ...
  partnersPage: {
    ...
    tigerSubtitle: '한국 웹3 마켓맵',
    tigerTitle: '한국 시장은',
    tigerHighlight: '타이거 리서치와 함께',
    tigerDesc: '아시아 시장 전문 웹3 리서치 기업인 타이거 리서치에서 매년 발간하는 한국 리서치 리포트를 기반으로 만든 마켓맵입니다. 한국의 플레이어를 전반적으로 설명하여, 한국 시장에 진출하는 기업들에게 도움이 되는 인사이트와 정보를 담고 있습니다.',
    tigerBtnText: '마켓맵 보러가기',
