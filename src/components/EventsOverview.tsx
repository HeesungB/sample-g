...
const EventsOverview = () => {
  ...
  const mainEvents: EventDay[] = [
    ...
    { date: 'APR 17', events: [
      ...
      { title: 'CIS 2026 - Institutional Day', org: 'Xangle', time: '13:30pm - 21:00pm', location: 'The Plaza Seoul, Jung-Gu', logos: ['/org-xangle.png'] },
    ] },
    { date: 'APR 18', events: [
      { title: 'CIS 2026 - Retail Festival', org: 'Xangle', time: '10:00am - 18:00pm', location: 'S-Factory, Seong Su', logos: ['/org-xangle.png'] },
